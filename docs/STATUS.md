...
- **Real tool logos (2026-08-16):** the MCP table (slide 11) now shows the Jira,
  TestRail, Jenkins and Confluence logos instead of emoji, generated by
  `scripts/build-logos.js` from `simple-icons` and committed as SVG. Colours
  and trademark notes in `slides/img/logos/README.md`.
